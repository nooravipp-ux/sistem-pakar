...
function answer($kode){
    ...
    if($kode=='T004'){
        echo "<a class='btn col-sm-1 mrg btn-lg btn-outline-light' href='bap.php?kode=T005R'>Ya</a>";
    ...
    if($kode=='T005R'){
        ...
        echo "<a class='btn col-sm-1 mrg btn-lg btn-outline-light' href='bap.php?kode='>Tidak</a>";
    }
    if($kode=='T006'){
